...
import {handleUpdateColumn} from '@/handlers/column/handle-update-column';
...
export default function UpdateColumnDialog({ handleClose, open, id, name, alias, isForeignKey, isPrimaryKey, dataType, tableId }: UpdateColumnDialogProps) {
    ...
    <Dialog open={open} onClose={handleClose} maxWidth='md'>
      <Formik
        ...
        onSubmit={async (values, actions) => {
          await handleUpdateColumn(values, actions, setTables);
          handleClose();
        }}
      >
